  ...
  return (
    <>
      ...
      <div className="container vision_P text_justify">
        <p>
          Mr. Shafiqul Alam strongly believes that Bangladesh must grow on its own and proper education determines the destiny of individual and society and as a whole the nation. Bangladesh is a very small country with huge population and we proved ourselves as a country with enormous potentiality. One very good point about the peoples of <br />the country is that we can fight against any unfavorable situation and have the courage to take the challenges of creating favorable social, economic and environmental condition. So Bangladesh peoples can do anything and can change the economy.
          <br />
